...
final class PdoLinkPreviewRepository implements LinkPreviewRepository
{
    ...
    public function create(array $preview): int
    {
        $statement = $this->pdo->prepare(
            'INSERT INTO jarvis_link_previews (household_id, user_id, recipe_link_id, token_hash, url_hash, platform, normalized_url, title, description, image_url, temp_image_path, image_mime_type, site_name, fetched_at, expires_at) '
